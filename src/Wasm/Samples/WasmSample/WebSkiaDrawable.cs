...
/// <summary>
/// Minimal ISkiaDrawable for the Web target. Holds the SKSurface that the host
/// renders into and reports frame timing back to DrawnUI.
/// Modeled after DrawnUi.OpenTk.GpuDrawable.
/// </summary>
public sealed class WebSkiaDrawable : ISkiaDrawable
{

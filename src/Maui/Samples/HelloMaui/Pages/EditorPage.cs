...
/// platform looks. Ported from HelloWpf / the React demo's EditorPage.tsx. On MAUI each focused editor
/// is backed by a hidden native text control, so the system keyboard, IME and clipboard just work.
/// </summary>
                ...
                Content = new SkiaStack
                {
                    ...
                    Children = new List<SkiaControl>
                    {
                        ...
                        Card(Title("").Assign(out _singleTitle),
                            ...
                            new SkiaLabel("The focused drawn editor is backed by a hidden native text control (TextBox / EditText / UITextView): the soft keyboard, IME composition, selection keys and the system clipboard come from the platform, the text and caret are drawn.")
                            {

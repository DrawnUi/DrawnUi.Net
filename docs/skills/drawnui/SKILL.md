...
- **Posterize / zone look without pixel speckle, cheap enough for realtime video** (verified 2026-09-13, neon pop-art filter: 82 -> 17 samples per pixel, CPU render 11.4 s -> 1.3 s at 2160x2880, isolated zone-flip pixels at 100% zoom 1.33% -> 0.10%, same look at preview size and fit-to-screen 4x):
